...
int main() {
    ...
    cout<<"Enter the 1st heuristic value : ";
    cin>>heuristic_1;
    cout<<endl;
    cout<<"Enter the 2nd heuristic value : ";
    cin>>heuristic_2;
    cout<<endl;
    ...
    while(true){
        ...
        cout<<"Computer 1's turn : "<<result.second<<endl;
        m.print_mancala(m.mancala);
        if(!t){
                break;
        }
        else{
            cout<<"Computer 1 has got an extra turn!!"<<endl;
        }
    ...
    while(true){
        ...
        result = alphabeta(m, depth, alpha, beta,!isMaximizingPlayer);
        bool t=m.player_move(result.second);
        cout<<"Computer 2's turn : "<<result.second<<endl;
        m.print_mancala(m.mancala);
        if(!t){
                break;
        }
        else{
            cout<<"Computer 2 has got an extra turn!!"<<endl;
        }
    }
    ...
    if(m.mancala[6]>m.mancala[13]){
        ...
        cout<<" Computer 1's Score : "<<m.mancala[6]<<endl;
        cout<<"Computer 2's Score : "<<m.mancala[13]<<endl;
        break;
        }
 else{
        continue;
